    ...
    <section className="py-16 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Bizning xizmatlarimiz</h2>
          <p className="text-xl text-gray-600 dark:text-gray-400">Mijozlarimizga eng yaxshi xizmat ko'rsatamiz</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {services.map((service, index) => {
            ...
            return (
              <Card
                key={index}
                className="text-center p-4 md:p-6 border-green-100 dark:border-gray-700 hover:shadow-lg transition-shadow dark:bg-gray-800"
              >
                <CardContent className="space-y-3 md:space-y-4">
                  <div
                    className={`w-12 h-12 md:w-16 md:h-16 rounded-full ${service.color} flex items-center justify-center mx-auto`}
                  >
                  ...
                  <div>
                    ...
                    <p className="text-sm md:text-base text-gray-600 dark:text-gray-400">{service.description}</p>
                  </div>
                </CardContent>
              </Card>
            )
